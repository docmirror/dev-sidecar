...
module.exports = {
	...
	config: {
		...
		remoteDomesticDomainAllowListFileUrl:
			"https://raw.githubusercontent.com/pluwen/china-domain-allowlist/refs/heads/main/allow-list.sorl",
		domesticDomainAllowListFileAbsolutePath: null, // 自定义 domestic-domain-allowlist.txt 文件位置，可以是本地文件路径
		domesticDomainAllowListFilePath:
			"./extra/proxy/domestic-domain-allowlist.txt", // 内置国内域名文件
