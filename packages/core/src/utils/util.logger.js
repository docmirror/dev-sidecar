...
// 通用日志配置
const maxLogFileSizeMultiple = 1024 * 1024 * (configFromFiles.app.maxLogFileSizeUnit === 'GB' ? 1024 : 1) // 目前单位只有GB和MB
const appenderConfig = {
  ...
  maxLogSize: (configFromFiles.app.maxLogFileSize || 0) * maxLogFileSizeMultiple,
}
