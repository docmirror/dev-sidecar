	...
	(function() {
		...
		function addGitClone(target) {
			...
			if (html.parentElement.parentElement.className.indexOf('XIU2-GCP') === -1){
				...
				html.parentElement.parentElement.addEventListener('click', (e)=>{if (e.target.tagName === 'INPUT') {GM_setClipboard(e.target.value, {notificationTitle:'clone命令已复制：',notification:e.target.value});}})
			}
		}
